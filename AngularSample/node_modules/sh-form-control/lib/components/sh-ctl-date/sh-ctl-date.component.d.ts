...
export declare class SHCtlDateComponent extends SHFormControl<Date> implements OnInit, OnChanges {
    stringValue: any;
     ...
     * @param value
     */
    changeFormat(value: Date): string;
}
