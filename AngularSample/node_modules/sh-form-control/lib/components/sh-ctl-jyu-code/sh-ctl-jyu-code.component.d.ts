...
export declare class SHCtlJyuCodeComponent extends SHFormPopup implements OnInit, OnChanges {
    ...
    */
     ...
     * @param inputValue
     */
    hiraganaToKatagana(inputValue: any): any;
    /**
     * 入力文字を半角カナに変換
     * @param inputValue
     */
    toHankaku(inputValue: any): string;
}
