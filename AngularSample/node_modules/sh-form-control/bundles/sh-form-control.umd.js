(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@angular/common'), require('@angular/material'), require('moment'), require('sh-http-client'), require('rxjs'), require('@angular/cdk/collections')) :
    typeof define === 'function' && define.amd ? define('sh-form-control', ['exports', '@angular/core', '@angular/forms', '@angular/common', '@angular/material', 'moment', 'sh-http-client', 'rxjs', '@angular/cdk/collections'], factory) :
    (global = global || self, factory(global['sh-form-control'] = {}, global.ng.core, global.ng.forms, global.ng.common, global.ng.material, global.moment_, global.shHttpClient, global.rxjs, global.ng.cdk.collections));
}(this, (function (exports, core, forms, common, material, moment_, shHttpClient, rxjs, collections) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var SHCtlPopupDialogMultiComponent = /** @class */ (function () {
        ...
        */
        ...
        function () {
            ...
            /** @type {?} */
            var numRows = this.unchangeableCodes && this.unchangeableCodes.length ? this.unchangeableCodes.length : 0;
    ...
    var SHCtlWideCharComponent = /** @class */ (function (_super) {
        ...
        function SHCtlWideCharComponent() {
            ...
            //入力変換時を補足するための値保持
            _this._data = "";
            _this.allowkeys = ["ArrowLeft", "ArrowRight", "ArrowDown", "ArrowUp"];
         ...
         * @return {?}
         */
        SHCtlWideCharComponent.prototype.isAllowkeys = /**
         * @private
         * @param {?} key
         * @return {?}
         */
    ...
    if (false) {
         ...
         * @private
         */
        SHCtlWideCharComponent.prototype.allowkeys;
    }
    ...
    var SHCtlWideCharMLComponent = /** @class */ (function (_super) {
         ...
         * @return {?}
         */
        SHCtlWideCharMLComponent.prototype.isAllowkeys = /**
         * @private
         * @param {?} key
         * @return {?}
         */
    ...
    var SHCtlYearMonthComponent = /** @class */ (function (_super) {
        ...
        function SHCtlYearMonthComponent(el) {
            ...
            _this.date = new forms.FormControl(moment$1());
            _this.max = "9999-12";
            _this.min = "1000-12";
            ...
            if (this.SmplPopupService.getMasterData(this.apiUrl).length == 0) {
                ...
                function (response) {
                    ...
                    if (_this.dialogRef.componentInstance) {
                        ...
                        /** @type {?} */
                        var cols_1 = ['select'];
                        _this.dialogRef.componentInstance.getHashKeys().forEach((/**
                         * @param {?} name
                         * @param {?} idx
                         * @return {?}
                         */
    ...
    exports.ɵba = ShCtlPopupComponent;
    exports.ɵbb = ShCtlPopupMultiComponent;
    exports.ɵbc = SHCtlPopupDialogComponent;
    exports.ɵbd = SHCtlPopupDialogMultiComponent;
    exports.ɵbe = ShCtlValidatedErrorComponent;
    exports.ɵbf = SHCtlHalfNumberComponent;
    exports.ɵbg = SHCtlCheckComponent;
    exports.ɵbh = SHCtlLockScreenComponent;
    exports.ɵbi = NgDateValuePipe;
    exports.ɵbj = ShCtlStateDirective;
    exports.ɵc = SHCtlAllCharMLComponent;
    exports.ɵd = SHCtlBunjNoComponent;
    exports.ɵe = SHCtlDateComponent;
    exports.ɵf = SHCtlHalfCharComponent;
    exports.ɵg = SHCtlJigCodeComponent;
    exports.ɵh = SHFormPopup;
    exports.ɵi = SmplPopupService;
    exports.ɵj = BindCtlService;
    exports.ɵk = LockScreenService;
    exports.ɵl = SHCtlJyuCodeComponent;
    exports.ɵm = SHCtlKatakanaComponent;
    exports.ɵn = SHCtlNumberComponent;
    exports.ɵo = SHCtlSesyuCodeComponent;
    exports.ɵp = SHCtlTanCodeComponent;
    exports.ɵq = SHCtlTelNoComponent;
    exports.ɵr = SHCtlTimeComponent;
    exports.ɵs = SHCtlTokuCodeComponent;
    exports.ɵt = SHCtlWideCharComponent;
    exports.ɵu = SHCtlWideCharMLComponent;
    exports.ɵv = SHCtlYearMonthComponent;
    exports.ɵw = SHCtlZipNoComponent;
    exports.ɵx = SHCtlKbnRadioComponent;
    exports.ɵy = SmplKbnCodeService;
    exports.ɵz = SHCtlKbnSelectComponent;
