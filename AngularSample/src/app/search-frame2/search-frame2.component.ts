...
@Component({
  selector: 'app-search-frame2',
  templateUrl: './search-frame2.component.html',
  styleUrls: ['./search-frame2.component.css']
})
export class SearchFrameComponent2 implements OnInit {
